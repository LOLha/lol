...
public class LayerPlayer2 extends Layer{
	...
	public LayerPlayer2(int x, int y, int w, int h) {
		super(x, y, w, h);
	}
	...
	protected void paint(Graphics g) {
		super.createFrame(g);
		if(this.dto.getCube1()==null)return;
		Point[] actPoints = this.dto.getCube1().getActPoint();
		this.drawShadow(true,actPoints,g);
		int typeCode = this.dto.getCube1().getTypeCode();
       ...
       boolean map[][] = this.dto.getGameMap1();
